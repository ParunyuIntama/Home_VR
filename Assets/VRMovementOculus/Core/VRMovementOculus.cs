...
public class VRMovementOculus : MonoBehaviour
{
    ...
    public enum eHMD { Rift, Go,};
    [Header("-Oculus Settings-")]
    public eHMD oculusType = eHMD.Rift;
    [HideInInspector]
    ...
    private void NewMethod3(OVRCameraRig ObjectHolder)
    {
        NewMethod2(ObjectHolder);
    }

    private void NewMethod2(OVRCameraRig ObjectHolder)
    {
        NewMethod1(ObjectHolder);
    }

    private void NewMethod1(OVRCameraRig ObjectHolder)
    {
        NewMethod(ObjectHolder);
    }

    private void NewMethod(OVRCameraRig ObjectHolder)
    {
